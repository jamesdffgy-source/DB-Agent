(function () {
  ...
  const ENGLISH = Object.freeze({
    ...
    '工作检查点不属于长期层。只有真实完成的只读执行能强化记忆；纠错会降权，所有内容严格绑定当前数据库、授权范围和结构版本。': 'The working checkpoint is not a long-term layer. Only completed read executions can strengthen memory; corrections reduce confidence, and every record is bound to the current database, access scope, and schema version.',
